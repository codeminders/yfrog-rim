...
public class FollowersScreen extends TopScreenBase
    implements NetworkListener, ImageDataListener
{

    private static FollowersScreen _instance = null;

    public static synchronized FollowersScreen getInstance() {
        if (_instance == null)
            _instance = new FollowersScreen();
        return _instance;
    }
    ...
    private FollowersScreen() {
        super(TITLE_FOLLOWERS);
